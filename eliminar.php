...
<body class="container">
    ...
    <form method="post">
        ...
        <?php
            ...
            echo '<input type="text" class="form-control" disable value="'.$dato['FechaAlta'].'">';
            echo '<label>Fecha de Alta</label></div>';
            
            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['FechaVenta'].'">';
            echo '<label>Fecha de Venta</label></div>';

            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['Tipo'].'">';
            echo '<label>Tipo de Propiedad</label></div>';
            
            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['Operacion'].'">';
            echo '<label>Tipo de Operacion</label></div>';

            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['Provincia'].'">';
            echo '<label>Estado</label></div>';
            
            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['Superficie'].'">';
            echo '<label>Superficie en M2</label></div>';//

            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['PrecioVenta'].'">';
            echo '<label>Precio de Venta</label></div>';

            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['Vendedor'].'">';
            echo '<label>Vendedor a Cargo</label></div>';
            
            echo '<div class="form-floating mb-3">';
            echo '<input type="text" class="form-control" disable value="'.$dato['Comision'].'">';
